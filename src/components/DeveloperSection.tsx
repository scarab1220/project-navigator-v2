...
const technologies = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 128 128" className="w-10 h-10">
        <path fill="#F05340" d="M27.271 95.779c-7.953 0-13.645-1.702-16.916-5.063C7.209 87.439 5.5 82.282 5.5 74.957V53.483h11.104v21.474c0 5.054 1.058 8.533 3.145 10.342 2.088 1.81 5.691 2.729 10.707 2.729h.815v7.751h-4zm63.452-41.011c-4.744 0-8.915.966-12.394 2.869-3.479 1.904-6.164 4.639-7.975 8.125-1.811 3.487-2.729 7.607-2.729 12.236 0 7.071 1.925 12.553 5.752 16.296 3.828 3.743 9.308 5.627 16.286 5.627 4.582 0 8.751-.949 12.384-2.818 3.632-1.869 6.452-4.567 8.381-8.016 1.929-3.449 2.907-7.536 2.907-12.139 0-7.08-1.939-12.552-5.792-16.286-3.852-3.735-9.38-5.614-16.555-5.894h-.265zm.461 7.751c4.124 0 7.294 1.315 9.413 3.914 2.119 2.598 3.2 6.372 3.2 11.183 0 4.973-1.065 8.838-3.162 11.498-2.096 2.66-5.193 4.007-9.211 4.007-4.125 0-7.296-1.323-9.414-3.937-2.118-2.614-3.2-6.381-3.2-11.183 0-4.866 1.102-8.698 3.278-11.371 2.176-2.672 5.206-4.024 9.019-4.111h.077zM29.086 95.779V55.283h-2.729l-5.497 7.556h-9.67l7.751-9.551c.786-.949 1.503-1.702 2.119-2.235.615-.533 1.231-.935 1.81-1.177a8.35 8.35 0 011.927-.605 13.047 13.047 0 012.158-.158h12.866v46.666h-10.735z"/>
      </svg>
    ),
    category: "Backend",
  },
      ...
      <div className="container-narrow">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Beyond project management, I bring hands-on development experience that enables me 
            to communicate effectively with engineering teams and understand technical complexities.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-6 mb-12">
          {technologies.map((tech, index) => (
            <div 
              key={index} 
              className="flex flex-col items-center p-4 bg-background rounded-xl border border-border/50 hover:border-accent/50 hover:shadow-lg transition-all duration-300 group"
            >
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-4 px-6 py-4 bg-primary/5 rounded-lg border border-primary/10">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-muted-foreground">
                Hands-on coding experience means better sprint planning, accurate estimations, and effective developer communication
              </p>
            </div>
          </div>
        </div>
